...
{
    LIBRARY::multimap<int, int> map;

    map.insert(LIBRARY::make_pair(0, 2));
    assert(map.size() == 1);
    map.insert(LIBRARY::make_pair(1, 5));
    assert(map.size() == 2);
    map.insert(LIBRARY::make_pair(1, 8));
    assert(map.size() == 3);

    for (size_t l = 0; l < 50; l++)
        map.insert(LIBRARY::make_pair(l, 2 * l));
...
{
    LIBRARY::multimap<int, int> map;
    map.insert(LIBRARY::make_pair(0, 50));
    map.insert(LIBRARY::make_pair(90, 5));
    map.insert(LIBRARY::make_pair(2, 80));

    assert(map.size() == 3);

    LIBRARY::multimap<int, int> cpy;
    assert(cpy.size() == 0);
    ...
    cpy.insert(LIBRARY::make_pair(5, 8));
    map.insert(LIBRARY::make_pair(5, 80));
    map.insert(LIBRARY::make_pair(9, 80));
    ...
    LIBRARY::multimap<int, int> cpy2(cpy);
...
static void test_iterators()
{
    ...
    LIBRARY::multimap<int, int>::iterator ite = map.begin();
    assert(ite->first == 0);
    ...
    const LIBRARY::multimap<int, int> &map2 = map;

    LIBRARY::multimap<int, int>::const_iterator ite2 = map2.end();
    --ite2;
...
static void test_reverse_iterators()
{
    ...
    LIBRARY::multimap<int, int>::reverse_iterator ite = map.rbegin();
    assert(ite->first == 90);
    assert(ite->second == 5);
    assert((++ite)->first == 2);
    assert((ite++)->second == 80);
    ...
    LIBRARY::multimap<int, int>::const_reverse_iterator ite2 = map2.rend();
    --ite2;
...
static void test_insert()
{
    ...
    LIBRARY::pair<int, int> tab[6] = {
        LIBRARY::make_pair(0, 1),
        LIBRARY::make_pair(50, 2),
        LIBRARY::make_pair(6, 4),
        LIBRARY::make_pair(-45, -5),
        LIBRARY::make_pair(4, 98),
        LIBRARY::make_pair(6, 9),
    };
...
static void test_cmp()
{
    ...
    LIBRARY::multimap<int, int> map2;
    map2.insert(LIBRARY::make_pair(0, 50));
    map2.insert(LIBRARY::make_pair(90, 5));
    map2.insert(LIBRARY::make_pair(2, 80));
    ...
    map.insert(LIBRARY::make_pair(1, 4));
    assert(map != map2);
    assert(map2 > map);
    assert(map2 >= map);
    assert(!(map2 < map));
...
{
    LIBRARY::multimap<int, int> map;
    map.insert(LIBRARY::make_pair(10, 96));
    map.insert(LIBRARY::make_pair(36, 9));
    map.insert(LIBRARY::make_pair(8, 8));
...
static void test_range()
{
    ...
    map.insert(LIBRARY::make_pair(36, 9));
    map.insert(LIBRARY::make_pair(8, 8));
    map.insert(LIBRARY::make_pair(8, 10));
    ...
    typedef LIBRARY::multimap<int, int>::iterator iter;
    LIBRARY::pair<iter, iter> range;
