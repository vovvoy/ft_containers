...
{
	ft::list<double> first, second;
	ft::list<double>::iterator it, it2;
...
{
	ft::list<int> foo(3, 100);	 // three ints with a value of 100
	ft::list<int> bar(2, 200);	 // two ints with a value of 200
...
{
	ft::list<int> list(3, 100);  // three ints with a value of 100
	ft::list<int>::const_iterator it;
	ft::list<int>::const_iterator it3(it);
